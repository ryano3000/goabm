...
func (*AgentStatusRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_agent_feb0e30e976328d1, []int{0}
}
...
func (*AgentStatusResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_agent_feb0e30e976328d1, []int{1}
}
...
func init() { proto.RegisterFile("agent.proto", fileDescriptor_agent_feb0e30e976328d1) }

var fileDescriptor_agent_feb0e30e976328d1 = []byte{
	...
	0xb0, 0x58, 0x61, 0xc0, 0x98, 0xc4, 0x06, 0x76, 0x98, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x88,
	0x66, 0xdf, 0x2a, 0xa7, 0x00, 0x00, 0x00,
}
